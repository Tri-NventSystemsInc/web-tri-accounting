...
public class SupplierController {
    ...
    @ResponseBody
    public CreateResponse createSupplier(@Valid @RequestBody Supplier supplier, BindingResult bindingResult) {
    ...
    @ResponseBody
    public CreateResponse updateSupplier(@Valid @RequestBody Supplier supplier, BindingResult bindingResult) {
