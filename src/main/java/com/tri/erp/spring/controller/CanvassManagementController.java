...
public class CanvassManagementController {
    ...
    private final String BASE_PATH = "cnvs/partials/";
    private final String MAIN = "cnvs/main";
    ...
    @RequestMapping(value = "/new-cnvs-page", method = RequestMethod.GET)
    public String newCnvs(HttpServletRequest request) {
