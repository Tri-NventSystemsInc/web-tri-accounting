...
<button title="browse account"  class="btn btn-primary" data-toggle="modal" data-target="#itemBrowserModal"> {{ btnLabel }}</button>

<div class="modal fade" id="itemBrowserModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
