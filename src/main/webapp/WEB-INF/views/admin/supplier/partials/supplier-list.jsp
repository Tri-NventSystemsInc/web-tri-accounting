...
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="alert alert-info" style="margin-bottom: 5px;">Supplier <span class="pull-right" style="cursor: pointer"><i class="fa fa-plus" title="Add supplier" onclick="(window.location.href = '#/new')"></i></span></div>
    </div>
</div>
