                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive project-list">
                                <table class="table table-striped ">
                                    ...
                                    <tr >
                                        <td class="project-status" style="width: 100px">
                                            <span class="label label-warning " ><i class="fa fa-flag-o"></i>&nbsp;Returned</span>
                                        </td>
                                        <td style="width: 180px" align="center">
                                        ...
                                        <td>
                                            <span class="label label-info " style="width: 100px">JO</span>
                                        </td>
                                        <td  style="width: 150px" align="center">
                                            <div class="btn-group" dropdown >
                                                <button type="button" class="btn  btn-primary btn-group btn-sm dropdown-toggle"><i class="fa fa-hand-o-right"></i>&nbsp;&nbsp;
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <span class="label label-default " style="width: 100px">Labor</span>
                                        </td>
                                        <td  style="width: 150px" align="center">
                                            <div class="btn-group" dropdown >
                                                <button type="button" class="btn  btn-primary btn-group btn-sm dropdown-toggle"><i class="fa fa-hand-o-right"></i>&nbsp;&nbsp;
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <span class="label label-success " style="width: 100px">IT</span>
                                        </td>
                                        <td  style="width: 150px" align="center">
                                            <div class="btn-group" dropdown >
                                                <button type="button" class="btn  btn-primary btn-group btn-sm dropdown-toggle"><i class="fa fa-hand-o-right"></i>&nbsp;&nbsp;
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <span class="label label-danger " style="width: 100px">Repair</span>
                                        </td>
                                        <td  style="width: 150px" align="center">
                                            <div class="btn-group" dropdown >
                                                <button type="button" class="btn  btn-primary btn-group btn-sm dropdown-toggle"><i class="fa fa-hand-o-right"></i>&nbsp;&nbsp;
