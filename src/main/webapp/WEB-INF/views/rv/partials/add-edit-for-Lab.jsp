...
<div class="ibox-title">
    <h5>Create New Requisition For Labor</h5>
</div>
            ...
            <div class="table-responsive white-bg">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>Reading of kilowatthour meters of Brgy. Talongadian, Sta. Barbara</td>
                        <td>&nbsp;&nbsp;2 pcs</td>
                    ...
                    <tr>
                        ...
                        <td>Distribution of Statement of Account and Disconnection Notice</td>
                        <td>&nbsp;&nbsp;2.6 pcs</td>
                        <td style="text-align: center"><a style='padding: 0' title='Edit'><i class='fa fa-edit'></i></a>&nbsp;&nbsp;<a style='padding: 0' title='Remove'><i class='fa fa-minus'></i></a></td>
                    </tr>
                    <tr>
