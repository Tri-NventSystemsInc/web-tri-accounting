...
<div class="row">
    <div class="col-md-12 col-lg-12">
        ...
        <div class="col-md-5 col-lg-5">
            <div class="input-group">
                <span class="input-group-addon"><i class="glyphicon glyphicon-filter"></i></span>
                <input disabled="" ng-model="selectedConformOfficer.name" id="conform" name="conform" class="form-control ng-pristine ng-valid" type="text" placeholder="Browse Conforming Officer"/>
            </div>
        </div>
        <div class="col-md-5 col-lg-5">
            <button sl-entity-browser
                    ...
                    types="signatories"
                    class="btn btn-primary">Browse Conforming Officer</button>
        </div>
        <form-error err_field="errors.err_checker"></form-error>
    </div>
</div>
