var itemManagementCtrls = angular.module('itemManagementCtrl', ['ngResource', 'ngSanitize']);

itemManagementCtrls.controller('itemListCtrl', ['$scope', '$http', 'itemFactory',
...
itemManagementCtrls.controller('addEditItemCtrl', ['$scope', '$routeParams', '$http', 'itemFactory', 'errorToElementBinder',
    'csrf',
...
itemManagementCtrls.controller('itemDetailsCtrl', ['$scope', '$routeParams', '$http', 'itemFactory',
